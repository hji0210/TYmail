    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="/like/list?page=1">즐겨찾기</a></li>
          <li><a href="/spam/list?page=1">스팸 메일함</a></li>
          <li><a href="/trash/list?page=1">휴지통</a></li>
                ...
                <c:choose>
                    <c:when test="${category eq 'receive'}">
                        <c:if test="${filter eq ''}">
                            <ol>
                                <li>
                                    <h2 onclick="location.href='/receive/list?page=${page}'" style="font-weight: normal"><i class="bi bi-chevron-compact-left"></i>받은메일함</h2>
                                </li>
                            </ol>
                        </c:if>
                        ...
                        <c:if test="${filter eq 'all'}">
                            <ol>
                                <li>
                                    <h2 onclick="location.href='/receive/list/folder?filter=${filter}&sort=${sort}&page=${page}'" style="font-weight: normal"><i class="bi bi-chevron-compact-left"></i>받은메일함(모든 메일)</h2>
                                </li>
                            </ol>
                        </c:if>
                        ...
                        <c:if test="${filter eq 'unread'}">
                            <ol>
                                <li>
                                    <h2 onclick="location.href='/receive/list/folder?filter=${filter}&sort=${sort}&page=${page}'" style="font-weight: normal"><i class="bi bi-chevron-compact-left"></i>받은메일함(안읽은 메일)</h2>
                                </li>
                            </ol>
                        </c:if>
                        ...
                        <c:if test="${filter eq 'mark'}">
                            <ol>
                                <li>
                                    <h2 onclick="location.href='/receive/list/folder?filter=${filter}&sort=${sort}&page=${page}'" style="font-weight: normal"><i class="bi bi-chevron-compact-left"></i>받은메일함(중요 메일)</h2>
                                </li>
                            </ol>
                        </c:if>
                        ...
                        <c:if test="${filter eq 'attach'}">
                            <ol>
                                <li>
                                    <h2 onclick="location.href='/receive/list/folder?filter=${filter}&sort=${sort}&page=${page}'" style="font-weight: normal"><i class="bi bi-chevron-compact-left"></i>받은메일함(첨부 메일)</h2>
                                </li>
                            </ol>
                        </c:if>
                        ...
                        <c:if test="${filter eq 'null'}">
                            <ol>
                                <li>
                                    <h2 onclick="location.href='/receive/list/folder?filter=${filter}&sort=${sort}&page=${page}'" style="font-weight: normal"><i class="bi bi-chevron-compact-left"></i>받은메일함</h2>
                                </li>
                            </ol>
                        </c:if>
                    </c:when>

                    <c:when test="${category eq 'promotionDetail'}">
                        <c:if test="${filter eq ''}">
                            <ol>
                                <li>
                                    <h2 onclick="location.href='/smart/promotion?page=${page}'" style="font-weight: normal"><i class="bi bi-chevron-compact-left"></i>프로모션</h2>
                                </li>
                            </ol>
                        </c:if>
                        ...
                        <c:if test="${filter eq 'all'}">
                            <ol>
                                <li>
                                    <h2 onclick="location.href='/smart/promotion/folder?filter=${filter}&sort=${sort}&page=${page}'" style="font-weight: normal"><i class="bi bi-chevron-compact-left"></i>프로모션(모든 메일)</h2>
                                </li>
                            </ol>
                        </c:if>
                        ...
                        <c:if test="${filter eq 'unread'}">
                            <ol>
                                <li>
                                    <h2 onclick="location.href='/smart/promotion/folder?filter=${filter}&sort=${sort}&page=${page}'" style="font-weight: normal"><i class="bi bi-chevron-compact-left"></i>프로모션(안읽은 메일)</h2>
                                </li>
                            </ol>
                        </c:if>
                        ...
                        <c:if test="${filter eq 'mark'}">
                            <ol>
                                <li>
                                    <h2 onclick="location.href='/smart/promotion/folder?filter=${filter}&sort=${sort}&page=${page}'" style="font-weight: normal"><i class="bi bi-chevron-compact-left"></i>프로모션(중요 메일)</h2>
                                </li>
                            </ol>
                        </c:if>
                        ...
                        <c:if test="${filter eq 'attach'}">
                            <ol>
                                <li>
                                    <h2 onclick="location.href='/smart/promotion/folder?filter=${filter}&sort=${sort}&page=${page}'" style="font-weight: normal"><i class="bi bi-chevron-compact-left"></i>프로모션(첨부 메일)</h2>
                                </li>
                            </ol>
                        </c:if>
                        ...
                        <c:if test="${filter eq 'null'}">
                            <ol>
                                <li>
                                    <h2 onclick="location.href='/smart/promotion/folder?filter=${filter}&sort=${sort}&page=${page}'" style="font-weight: normal"><i class="bi bi-chevron-compact-left"></i>프로모션</h2>
                                </li>
                            </ol>
                        </c:if>
                    </c:when>

                    <c:when test="${category eq 'chargeDetail'}">
                        <c:if test="${filter eq ''}">
                            <ol>
                                <li>
                                    <h2 onclick="location.href='/smart/charge?page=${page}'" style="font-weight: normal"><i class="bi bi-chevron-compact-left"></i>청구 및 결제</h2>
                                </li>
                            </ol>
                        </c:if>
                        ...
                        <c:if test="${filter eq 'all'}">
                            <ol>
                                <li>
                                    <h2 onclick="location.href='/smart/charge/folder?filter=${filter}&sort=${sort}&page=${page}'" style="font-weight: normal"><i class="bi bi-chevron-compact-left"></i>청구 및 결제(모든 메일)</h2>
                                </li>
                            </ol>
                        </c:if>
                        ...
                        <c:if test="${filter eq 'unread'}">
                            <ol>
                                <li>
                                    <h2 onclick="location.href='/smart/charge/folder?filter=${filter}&sort=${sort}&page=${page}'" style="font-weight: normal"><i class="bi bi-chevron-compact-left"></i>청구 및 결제(안읽은 메일)</h2>
                                </li>
                            </ol>
                        </c:if>
                        ...
                        <c:if test="${filter eq 'mark'}">
                            <ol>
                                <li>
                                    <h2 onclick="location.href='/smart/charge/folder?filter=${filter}&sort=${sort}&page=${page}'" style="font-weight: normal"><i class="bi bi-chevron-compact-left"></i>청구 및 결제(중요 메일)</h2>
                                </li>
                            </ol>
                        </c:if>
                        ...
                        <c:if test="${filter eq 'attach'}">
                            <ol>
                                <li>
                                    <h2 onclick="location.href='/smart/charge/folder?filter=${filter}&sort=${sort}&page=${page}'" style="font-weight: normal"><i class="bi bi-chevron-compact-left"></i>청구 및 결제(첨부 메일)</h2>
                                </li>
                            </ol>
                        </c:if>
                        ...
                        <c:if test="${filter eq 'null'}">
                            <ol>
                                <li>
                                    <h2 onclick="location.href='/smart/charge/folder?filter=${filter}&sort=${sort}&page=${page}'" style="font-weight: normal"><i class="bi bi-chevron-compact-left"></i>청구 및 결제</h2>
                                </li>
                            </ol>
                        </c:if>
                    </c:when>

                    <c:when test="${category eq 'snsDetail'}">
                        <c:if test="${filter eq ''}">
                            <ol>
                                <li>
                                    <h2 onclick="location.href='/smart/sns?page=${page}'" style="font-weight: normal"><i class="bi bi-chevron-compact-left"></i>SNS</h2>
                                </li>
                            </ol>
                        </c:if>
                        ...
                        <c:if test="${filter eq 'all'}">
                            <ol>
                                <li>
                                    <h2 onclick="location.href='/smart/sns/folder?filter=${filter}&sort=${sort}&page=${page}'" style="font-weight: normal"><i class="bi bi-chevron-compact-left"></i>SNS(모든 메일)</h2>
                                </li>
                            </ol>
                        </c:if>
                        ...
                        <c:if test="${filter eq 'unread'}">
                            <ol>
                                <li>
                                    <h2 onclick="location.href='/smart/sns/folder?filter=${filter}&sort=${sort}&page=${page}'" style="font-weight: normal"><i class="bi bi-chevron-compact-left"></i>SNS(안읽은 메일)</h2>
                                </li>
                            </ol>
                        </c:if>
                        ...
                        <c:if test="${filter eq 'mark'}">
                            <ol>
                                <li>
                                    <h2 onclick="location.href='/smart/sns/folder?filter=${filter}&sort=${sort}&page=${page}'" style="font-weight: normal"><i class="bi bi-chevron-compact-left"></i>SNS(중요 메일)</h2>
                                </li>
                            </ol>
                        </c:if>
                        ...
                        <c:if test="${filter eq 'attach'}">
                            <ol>
                                <li>
                                    <h2 onclick="location.href='/smart/sns/folder?filter=${filter}&sort=${sort}&page=${page}'" style="font-weight: normal"><i class="bi bi-chevron-compact-left"></i>SNS(첨부 메일)</h2>
                                </li>
                            </ol>
                        </c:if>
                        ...
                        <c:if test="${filter eq 'null'}">
                            <ol>
                                <li>
                                    <h2 onclick="location.href='/smart/sns/folder?filter=${filter}&sort=${sort}&page=${page}'" style="font-weight: normal"><i class="bi bi-chevron-compact-left"></i>SNS</h2>
                                </li>
                            </ol>
                        </c:if>
                    </c:when>
                        ...
                        <div class="entry-content">
                            ...
                            <table>
                                <tr>
                                    <td>
                                        <form method="post">
                                            <input type="hidden" name="no" value="${receiveResponseDTO.no}"><input type="hidden" name="filter" value="${filter}"><input type="hidden" name="sort" value="${sort}"><input type="hidden" name="category" value="${category}">
                                            <input type="submit" value="삭제" style="color: white; border: none; background: transparent;" onclick="javascript: form.action='/receive/update/trash'">                                         
                                        	<input type="submit" value="회신" style="color: #FFFC0F; border: none; background: transparent;" onclick="javascript: form.action='/send/replyEmail'">
                                        </form>
                            ...
                            <c:choose>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 600px"
                                        ...
                                        sort = "${sort}"
                                        page = "${page}"
                                        onclick="getUrlForDetail(this)">${nextReceiveResponseDTO.title}</td>
                                    <td>
                                ...
                                <c:when test="${empty nextReceiveResponseDTO}">
                                    <tr>
                                        ...
                                        <td style="width: 600px"
                                            ...
                                            sort = "${sort}"
                                            page = "${page}"
                                            onclick="getUrlForDetail(this)">${preReceiveResponseDTO.title}</td>
                                        <td>
