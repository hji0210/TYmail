...
<!-- ======= Blog Section ======= -->
    <section id="blog" class="blog">
      <div class="container" data-aos="fade-up">
		  ...
		  <!-- 메일함 -->  
		  <c:forEach items="${storageList}" var="storageList" varStatus="status">
		  <div class="entry" style="font-size: small">
			<table>
				<tr>
					<td class="items">
						<input type="checkbox" name="del" value="${storageList.storage_no}" style="color: #58151c">
					</td>
					
					<!-- ======= 첨부 파일 ======= --> 
                    <c:if test="${not empty storageList.file_path}">
                       <td class="items"><i class="bi bi-paperclip" style="font-size: 1rem; color: #58151c"></i></td>
                    </c:if>
                    <c:if test="${empty storageList.file_path}">
					...
					<td style = "width: 180px">${storageList.receive_email}</td>
                    <td style = "width: 300px">
                    	<a href="/storage/storageRewrite?receive_email=${storageList.receive_email}&title=${storageList.title}&content=${storageList.content}&storage_no=${storageList.storage_no}&file_path=${storageList.file_path}">${storageList.title}</a></td>
                    <td style = "width: 150px">${storageList.storage_date}</td>
				</tr>
			</table>
		  </div>
          </c:forEach> 
        ...
        <ul class="pagination" ></ul>            
           ...
           <div class="sidebar">
             ...
             <div class="sidebar-item search-form">
	                  ...
	                  <button type="submit" onclick= "javascript: form.action='/storage/storageList"><i class="bi bi-search"></i></button>
