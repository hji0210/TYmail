            ...
            <form method="post">
              <div class="row">
                <div class="col-md-6 form-group">
                  받는 사람
					<input type="text" name="receive_email" class="form-control" id="parent" value="${reply.send_id}" placeholder="email address" required>
                </div>
              ...
              <div class="form-group mt-3">
                제목
                <input type="text" class="form-control" name="title" id="subject" placeholder="Title" value="RE : ${reply.title}">
              </div>
              
              <div class="row">
              <div class="col-md-6 form-group">
                첨부파일
                <input type="text" class="form-control" name="file_path" id="file" placeholder="File" readonly>
              </div>
              </div>
              <div class="col-md-6 form-group mt-3 mt-md-0">
