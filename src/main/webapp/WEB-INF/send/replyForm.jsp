            ...
            <form method="post">
              <div class="row">
                <div class="col-md-6 form-group">
                  받는 사람
				  <input type="text" name="receive_email" class="form-control" id="parent" placeholder="email address" required>
                </div>
              ...
              <div class="form-group mt-3">
                제목
                <input type="text" class="form-control" name="title" id="subject" placeholder="Title" value="FW : ${reply.title}">
              </div>
              
              <div class="row">
              <div class="col-md-6 form-group">
                첨부파일
                <input type="text" class="form-control" name="file_path" id="file" placeholder="File" value="${reply.file_path}" readonly>
              </div>
              </div>
              <div class="col-md-6 form-group mt-3 mt-md-0">
...
* content : ${reply.content}
              ...
              <div class="my-3">
	              <button type="submit" onclick="javascript: form.action='/send/sendMail'">메일 보내기</button>
	              <button type="submit" onclick="javascript: form.action='/storage/storageMail'" style="background-color:gray">임시 저장하기</button>
              </div>
            </form>
