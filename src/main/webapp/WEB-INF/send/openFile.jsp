...
<title>Open File</title>
    ...
    <script type="text/javascript">
	    ...
	    function closeSelectFile() {
	        ...
	        opener.document.getElementById("file").value = arr;
            window.close()
	    }
    </script>
          ...
          <div class="col-lg-3">
          	<div class="row">
               <table style="margin-left: auto; margin-right: auto;">
				  <tr>
					<th><a class="nav-link active2 show" data-bs-toggle="tab">file name</a></th>
					<th><a class="nav-link active2 show" data-bs-toggle="tab">check</a></th>
				  </tr>
				  <c:forEach items="${files}" var="files">
				    <tr>
					      <td><a class="nav-link" data-bs-toggle="tab">${files}</a></td> 
					      <td><a class="nav-link" data-bs-toggle="tab"><input type="checkbox" name="fileList" id="checkedFile" value="${files}"></a></td>
				    </tr>
				  </c:forEach>
				</table>
				<br><br>
				<button type="button" onclick="closeSelectFile();">선택</button> 
          	</div>
          </div>
		</div>
      </div>
