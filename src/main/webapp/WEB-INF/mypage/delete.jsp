...
<head>
  ...
  * License: https://bootstrapmade.com/license/
  ...
  .mypageElement #submitButton:hover {
    background: #717d8a;
  }
  </style>
</head>
    ...
    <section id="mypage-update" class="mypage-index member" style="padding-top: 30px;">
      <div class="container">
        ...
        <div class="row g-3 mypageElement" style="display: none;">
          <form name="deleteForm" action="/mypage/leaveResult" method="post" onsubmit="return deleteSubmit();" class="member-form row g-3 justify-content-center">
            <div class="col-7 text-center">
              <img src="/member/image/alert_128.png">
            </div>
            <div class="col-7 text-center">
              <h3>정말 탈퇴하시겠습니까?</h3>
            </div>
            <div class="col-7 text-center">
              <button type="submit" id="submitButton">탈퇴</button>
              &nbsp;
              <a href="/mypage"><button type="button">취소</button></a>
              <input type="hidden" name="deleteResult" value="0">
            </div>
          </form>
        </div>
      </div>
    </section><!-- End Delete Section -->
