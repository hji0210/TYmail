...
<body>
  ...
  <main id="main">
    ...
    <!-- ======= Update Section ======= -->
    <section id="mypage-update" class="mypage-index member" style="padding-top: 30px;">
      <div class="container">
        <%--비밀번호 검사--%>
        <%@ include file="passwordCheck.jsp" %>
        
        <%--회원정보 수정--%>
        <div class="row g-3 mypageElement" style="display: none;">
          <form name="updateForm" action="/mypage/modifyResult" method="post" onsubmit="return updateSubmit();" class="member-form row g-3 justify-content-center">
            <div class="col-7">
              <label for="inputId" class="form-label">아이디</label>
              <input type="text" name="id" class="form-control" id="inputId" value="${userInfo.ID}" readOnly>
            </div>
            <div class="col-7">
              <label for="inputPassword" class="form-label">비밀번호</label>
              <div class="inputPassword">
                <input type="password" name="password" class="form-control" id="inputPassword" value="${userInfo.PASSWORD}" placeholder="알파벳, 숫자, 특수문자 포함 8~20자" maxlength="20" required>
                <i class="passwordShowButton bi bi-eye-fill" title="비밀번호 보이기"></i>
              </div>
			  <span id="pwMessage"></span>
			  <input type="hidden" name="pwCheck" value="Y">
            </div>
            <div class="col-7">
              <label for="inputName" class="form-label">성명</label>
              <input type="text" name="name" class="form-control" id="inputName" value="${userInfo.NAME}" placeholder="성명" required>
            </div>
            <div class="col-7">
              <label for="inputTel" class="form-label">전화번호</label>
              <input type="tel" name="tel" class="form-control" id="inputTel" value="${userInfo.TEL}" placeholder="010xxxxxxxx" required>
