...
<!-- ======= Header ======= -->
  ...
  <main id="main">
               ...
               <table style="margin-left: auto; margin-right: auto;">
				  ...
				  <c:forEach items="${addressList}" var="addressList">
				    <tr>
					      ...
					      <td><input type="checkbox" name="del" value="${addressList.no}"></td>
				    </tr>
				  </c:forEach>
				</table>
				<br>
	...
	<button type="button" onclick="closeShowContact();" style="background-color:gray;">닫기</button>
	<button type="button" onclick="deleteC();">삭제</button>  
