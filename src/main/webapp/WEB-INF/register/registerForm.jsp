...
<body>
  ...
  <main id="main">
    ...
    <!-- ======= Register Section ======= -->
    <section id="register" class="register member" style="padding-top: 30px;">
      <div class="container">
        <div class="row g-3">
          <form name="registerForm" action="/register/registerResult" method="post" onsubmit="return formSubmit();" class="register member-form row g-3 justify-content-center">
            <div class="col-7">
              <label for="inputId" class="form-label">아이디</label><br>
              <input type="text" name="id" class="form-control" id="inputId" placeholder="최대 20자" maxlength="20" required style="width: 200px; display: inline;">
              &nbsp;@tymail.com<br>
			  <span id="idMessage"></span>
			  <input type="hidden" name="idDuplication" value="N" style="display: none;">
            </div>
            <div class="col-7">
              <label for="inputPassword" class="form-label">비밀번호</label>
              <div class="inputPassword">
                <input type="password" class="form-control" id="inputPassword" name="password" placeholder="알파벳, 숫자, 특수문자 포함 8~20자" maxlength="20" required>
            ...
            <div class="col-7">
              ...
              <div class="inputPassword">
                <input type="password" class="form-control" id="inputPasswordRepeat" name="passwordRepeat" placeholder="알파벳, 숫자, 특수문자 포함 8~20자" maxlength="20" required>
                <i class="passwordShowButton bi bi-eye-fill" title="비밀번호 보이기"></i>
              </div>
              <span id="pwRepeatMessage"></span>
              <input type="hidden" name="pwRepeatCheck" value="N">
            </div>
            <div class="col-7">
              <label for="inputName" class="form-label">성명</label>
              <input type="text" name="name" class="form-control" id="inputName" placeholder="성명" required>
            </div>
            <div class="col-7">
              <label for="inputTel" class="form-label">전화번호</label>
              <input type="tel" name="tel" class="form-control" id="inputTel" placeholder="010xxxxxxxx" required>
			  <span id="telMessage"></span>
			  <input type="hidden" name="telDuplication" value="N">
            </div>
            <div class="col-7">
              <button type="submit">가입</button>
              <input type="hidden" name="insertResult" value="0">
            </div>
...
<!-- ======= Footer ======= -->
        ...
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="#">받은 메일함</a></li>
  ...
  <script src="/member/js/register/register.js"></script>
  <script src="/member/js/register/idCheck.js"></script>
  <script src="/member/js/common/passwordCheck.js"></script>
  <script src="/member/js/common/passwordShowButton.js"></script>
  <script src="/member/js/register/telCheck.js"></script>
</body>
