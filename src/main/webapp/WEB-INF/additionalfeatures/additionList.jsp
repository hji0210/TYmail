        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Swal.fire({
                    ...
                    form.action='/trash/remove'; // <— submit form programmatically
                    form.submit();
                });
            ...
            <div class="d-flex justify-content-between align-items-center">
                <c:choose>
                    <c:when test="${category eq 'trash'}">
                            <ol>
                                <li>
                                    <h2 style="font-weight: normal">휴지통</h2>
                                </li>
                            </ol>
                    </c:when>
                    <c:when test="${category eq 'like'}">
                            <ol>
                                <li>
                                    <h2 style="font-weight: normal">즐겨찾기</h2>
                                </li>
                            </ol>
                    </c:when>
                    <c:when test="${category eq 'spam'}">
                        <ol>
                            <li>
                                <h2 style="font-weight: normal">스팸 메일함</h2>
                            </li>
                        </ol>
                    </c:when>
                </c:choose>
                            ...
                            <c:choose>
                                <c:when test="${category eq 'trash'}">
                                    <table>
                                        <tr>
                                            <td>
                                                <input type="button" value="영구삭제" style="color: white; border: none; background: transparent;" onclick="deleteForever()">
                                                <input type="submit" value="이동" style="color: white; border: none; background: transparent;" onclick="javascript: form.action='/trash/move'">
                                            </td>
                                        </tr>
                                    </table>
                                </c:when>
                                <c:when test="${category eq 'like'}">
                                    <table>
                                        <tr>
                                            <input type="submit" value="삭제" style="color: white; border: none; background: transparent;" onclick="javascript: form.action='/like/move'">
                                        </tr>
                                    </table>
                                </c:when>
                                <c:when test="${category eq 'spam'}">
                                    <table>
                                        <tr>
                                            <input type="submit" value="삭제" style="color: white; border: none; background: transparent;" onclick="javascript: form.action='/spam/move'">
                                        </tr>
                                    </table>
                                </c:when>
                            </c:choose>
                    ...
                    <c:forEach items="${receiveResponseDTOList}" var="receiveResponseDTO" varStatus="status">
                        <div class="entry" style="font-size: small">
                            <div class="entry-content">
                                <table>
                                    <tr>
                                        <td class="items"><input type="checkbox" id="checkbox" name="checkbox" value="${receiveResponseDTO.no}" style="padding-bottom: 0px; color: #58151c"></td>
                                        ...
                                        <td style="width:180px">${receiveResponseDTO.sendName}</td>

                                        <!-- ======= 메일 세부 사항 ======= -->
                                        <td class="receive-mail-title" style="width:300px" 
                                            onclick="location.href='/addition/detail?no=${receiveResponseDTO.no}&category=${category}'">${receiveResponseDTO.title}
                                        </td>
                                        <!-- ======= END 메일 세부 사항 ======= -->
