      ...
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          ...
          <ol>
            ...
            <li>
            <c:choose> 
				<c:when test="${send_id eq null}">
					<a href="/login">Login</a>
				</c:when> 
				<c:otherwise>
					<a href="/mypage">${send_id}</a>
				</c:otherwise> 
			</c:choose> 
			</li>
          </ol>
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active" style="background-image: url(/assets/img/slide/slide-1.jpg)">
          <div class="carousel-container">
            <div class="container">
              <h2 class="animate__animated animate__fadeInDown">Welcome to <span>TY Mail</span></h2>
              <p class="animate__animated animate__fadeInUp"></p>
              <a href="/send/sendForm" class="btn-get-started animate__animated animate__fadeInUp scrollto">메일 보내기</a>
            </div>
          </div>
        </div>
 	  </div>
